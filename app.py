...
app.config['MAIL_USERNAME'] = 'srishanthsrigadde07@gmail.com'
app.config['MAIL_PASSWORD'] = 'worw yfaj cfbo nidj'
app.config['MAIL_DEFAULT_SENDER'] = 'srishanthsrigadde07@gmail.com'
